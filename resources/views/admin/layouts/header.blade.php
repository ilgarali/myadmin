...
<html lang="en">
    <head>
        ...
        <link
            rel="stylesheet"
            href="{{asset('back/')}}/assets/vendors/perfect-scrollbar/perfect-scrollbar.css"
        />
        <link
            rel="stylesheet"
            href="{{asset('back/')}}/assets/vendors/bootstrap-icons/bootstrap-icons.css"
        />
        <link rel="stylesheet" href="{{asset('back/')}}/assets/css/app.css" />
        <link
            rel="shortcut icon"
            href="{{asset('back/')}}/assets/images/favicon.svg"
            type="image/x-icon"
        />
                    ...
                    <div class="sidebar-header">
                        <div class="d-flex justify-content-between">
                            <div class="logo">
                                <a href="index.html"
                                    ><img
                                        src="{{asset('back/')}}/assets/images/logo/logo.png"
                                        alt="Logo"
                                        srcset=""
                                /></a>
                            </div>
